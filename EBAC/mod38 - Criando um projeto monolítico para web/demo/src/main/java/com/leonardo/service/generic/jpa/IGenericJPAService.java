package com.leonardo.service.generic.jpa;
 ...
 *         Interface genérica para operações de serviço que define os métodos
 *         básicos de CRUD (Create, Read, Update, Delete) para entidades
 *         persistentes.
 *
 */
